      ...
      switch (operation) {
        case "SignalWithStartWorkflowExecution":
          return composeInterceptors(
            ...
            "signalWithStartWorkflow",
            (request) =>
              next<SignalWithStartWorkflowRequest, SignalWithStartWorkflowResponse>(
                request,
              ),
          )(input as SignalWithStartWorkflowRequest) as Promise<
            nexus.NexusOperationHandle<unknown>
          >;
        default:
          return next(input);
      }
